      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto text-center space-y-8 animate-fade-in">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed animate-slide-up animate-delay-200">
            Harness the power of artificial intelligence to create, optimize, and scale advertising campaigns that deliver desired results.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-16 animate-fade-in animate-delay-300">
            <StatCounter end={125} suffix="%" label="Avg ROI Increase" />
            <StatCounter end={33} suffix="hrs" label="Campaign Launch" />
            <StatCounter end={4} suffix="M+" label="Ad Impressions" />
            <StatCounter end={97} suffix="%" label="Client Satisfaction" />
          </div>
        </div>
      </div>
