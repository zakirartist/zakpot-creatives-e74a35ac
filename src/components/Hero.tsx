    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden gradient-mesh">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto text-center space-y-8 animate-fade-in">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-display font-bold tracking-tight animate-slide-up animate-delay-100">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed animate-slide-up animate-delay-200">
            Harness the power of artificial intelligence to create, optimize, and scale advertising campaigns that deliver exceptional results.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-16 animate-fade-in animate-delay-300">
            {[
              ...
              { value: "48hrs", label: "Campaign Launch" },
