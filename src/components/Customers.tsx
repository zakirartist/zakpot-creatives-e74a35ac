...
const Customers = () => {
  ...
  const brands = [
    { name: "Brand 1", color: "hsl(0 84% 60%)" },
    { name: "Brand 2", color: "hsl(15 90% 50%)" },
    { name: "Brand 3", color: "hsl(0 100% 50%)" },
    { name: "Brand 4", color: "hsl(10 85% 55%)" },
    { name: "Brand 5", color: "hsl(5 88% 58%)" },
    { name: "Brand 6", color: "hsl(20 92% 52%)" },
  ];
      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {brands.map((brand, index) => (
            <div
              key={index}
              className="logo-card opacity-0 group"
            ...
            >
              <div className="relative h-32 bg-card border border-border/50 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-105 hover:shadow-glow hover:border-primary/50 backdrop-blur-sm overflow-hidden">
                ...
                <div className="relative z-10 text-center">
                  <div 
                    className="w-16 h-16 mx-auto mb-2 rounded-full flex items-center justify-center font-bold text-2xl"
                    style={{ 
