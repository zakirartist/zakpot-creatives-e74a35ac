      ...
      <div className="container mx-auto max-w-7xl">
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <p className="text-xl text-muted-foreground">
            Cutting-edge advertising services that combine artificial intelligence with creative excellence
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => {
            ...
            return (
              <Card
                key={service.title}
                className="p-8 bg-card/50 backdrop-blur-sm border-border/50 hover:border-primary/50 transition-all duration-300 group hover:shadow-elevated animate-slide-up"
