  ...
  return <section className="py-24 px-4 relative" id="services">
      <div className="container mx-auto max-w-7xl">
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <h2 className="text-4xl md:text-5xl font-display font-bold"> AI-Powered Digital Marketing Solutions<span className="gradient-text">AI-Powered Digital Marketing Solutions</span>
          </h2>
